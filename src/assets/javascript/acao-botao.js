...
const botao180 = document.querySelector(".btn.ligue180");

botao180.addEventListener("click", (e) => {
  const isMobile =
    /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
      navigator.userAgent
    );
  ...
  if (isMobile) {
    ...
    e.preventDefault();
    alert(
      "A função de ligar diretamente para 180 só está disponível em celulares. Para mais informações ou registrar a denúncia, acesse o site oficial."
    );
  }
});
